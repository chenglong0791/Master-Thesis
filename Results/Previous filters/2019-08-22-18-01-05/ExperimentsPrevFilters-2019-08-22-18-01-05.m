...
paramScript = 'param4Landmarks';    % Specify parameterisation script
...
pauseTime             = 0.00001;          % Time between two consecutive updates of live plots in seconds
...
%%
load '/Users/rob/Documents/Archive/Studies/Master Thesis/Results/Kidnapping/4 Landmarks/2018-09-21-21-56-07/2018-09-21-21-56-07.mat';
logFileName = datestr(now, 'yyyy-mm-dd-HH-MM-SS');
logFilePath = ['/Users/rob/Documents/Archive/Studies/Master Thesis/Results/', logFileName, '/'];
...
meanRmsErrorsPFCP      = mean(rmsErrorsPFCP, 1);
meanRmsErrorsPFSP      = mean(rmsErrorsPFSP, 1);
...
relPerformancePFCP     = 100 * meanRmsErrorsPFCP  / meanRmsErrorsPF;
relPerformancePFSP     = 100 * meanRmsErrorsPFSP  / meanRmsErrorsPF;
...
fprintf(['PFCP:                      %2.2f m',   newline ],  meanRmsErrorsPFCP);
fprintf(['PFSP:                      %2.2f m',   newline2],  meanRmsErrorsPFSP);
...
if plotFirstNSeconds
    ...
    plotErrors(t(1:index), [meanErrorsPF(1:index); meanErrorsUPF(1:index); ...
        ...
        meanRmsErrorsPFS; meanRmsErrorsUPFS; meanRmsErrorsPFCP; meanRmsErrorsPFSP], ...
...
plotErrors(t, [meanErrorsPF; meanErrorsUPF; meanErrorsPFC; meanErrorsUPFC; meanErrorsPFS; meanErrorsUPFS; meanErrorsPFCP; meanErrorsPFSP], ...
    [meanRmsErrorsPF; meanRmsErrorsUPF; meanRmsErrorsPFC; meanRmsErrorsUPFC; meanRmsErrorsPFS; meanRmsErrorsUPFS; meanRmsErrorsPFCP; meanRmsErrorsPFSP], ...

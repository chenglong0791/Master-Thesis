function p = hermite(n,var)
%HERMITE      Hermite polynomial (exactly representable up to degree n<=29)
%
%   p = hermite(n,var)
%
...
%  p(0,x) = 1
%  p(1,x) = 2*x
%  p(n,x) = 2*x*p(n-1,x) - 2*(n-1)*p(n-2,x)  for n>1
%

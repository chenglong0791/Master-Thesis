...
%2^53, therefore pmax=floor(bitmax/beta/(beta-1)):
%
...
% modified 12/21/13     S.M. Rump  comment
...
%
  ...
  case 'init'
    ...
    INTLAB_CONST.LONG_BETA = INTLAB_LONG_BETA;
    INTLAB_CONST.LONG_LOGBETA = INTLAB_LONG_LOGBETA;

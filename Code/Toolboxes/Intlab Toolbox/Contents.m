...
% Version 10.2  December-13-2017   1230 m-files, 47,193 lines of Matlab/Octave code w/o comments 
%                 (81,521 with comments),
%             supported by a test-case library with more than 82,000 lines of Matlab/Octave code w/o comments
%
...
%  affari       - Affine arithmetic package
%  fl           - IEEE754 k-bit binary arithmetic
...
%  accsumdot    - Reference implementations for sum/dot routines
...
%  INTLAB_Version_8     - Additions and changes in version 8
%  INTLAB_Version_9     - Additions and changes in version 9
%  INTLAB_Version_10    - Additions and changes in version 10
%  INTLAB_Version_10_1  - Additions and changes in version 10.1
%  INTLAB_Version_10_2  - Additions and changes in version 10.2
...
%
%IEEE754 k-bit arithmetic based on
...
%    and underdetermined linear systems, Numerical Algorithms, 66:309-322, 2013.
%
...
%  S.M. Rump. Gleitkommaarithmetik auf dem Prüfstand [Wie werden verifiziert(e) 
%    numerische Lösungen berechnet?]. Jahresbericht der Deutschen Mathematiker-
%    Vereinigung, 118(3):179–226, 2016. 
%
%Slopes based on
...
% modified 12/13/17     S.M. Rump  Version 10.2
%

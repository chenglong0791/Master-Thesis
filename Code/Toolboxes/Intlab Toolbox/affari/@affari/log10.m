function r = log10(a,see)
%LOG10        Affine arithmetic elementwise decimal logarithm  log10(a)
%
...
%
  ...
  if INTLAB_CONST.AFFARI_APPROX
    ...
    p = 1./(intval('log10')*X2);             % inclusion of slope

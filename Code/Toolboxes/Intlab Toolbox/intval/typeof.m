...
% fi   'flintval'          typeof(fl(infsup(1,2)));
% a    'affari'            typeof(affari(-3.2));
% g    'gradient'          typeof(gradient(4711));
% gi   'gradientintval'    typeof(gradient(midrad(2,1e-3)));
% ga   'gradientaffari'    typeof(gradient(affari(midrad(2,1e-3))));
...
% t    'taylor'            typeof(taylor((1:3)',5));
% ti   'taylorintval'      typeof(taylor(intval((1:3)'),5));
%

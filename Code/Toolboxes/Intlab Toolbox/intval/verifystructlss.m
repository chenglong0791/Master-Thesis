function [ X , Xintinf , Xintsup ] = verifystructlss(As,b)
%VERIFYSTRUCTLSS    Dense linear system solver for structured matrices
%
%   [ X , Xintinf , Xintsup ] = verifystructlss(As,b)
%
%input   As       Structured matrix, see belowO
...
% modified 01/15/16     S.M. Rump  renaming
%

function [L,X] = verifystructeig(As,lambda,xs)
%VERIFYSTRUCTEIG      Verification of eigencluster near (lamda,xs) for structured input matrix
%
%   [L,X] = verifystructeig(A,lambda,xs)
%
...
%  S.M. Rump: Kleine Schranken fuer Matrixprobleme, Karlsruhe, 1980,
...
% modified 01/15/16     S.M. Rump  renaming, warning
%
